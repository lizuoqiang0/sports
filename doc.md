...
# === AI 分析 ===
AI_MIN_CONFIDENCE: float = 0.58        # 通用下限；联赛/方向门槛可自动抬高到0.62/0.68/0.78
...
生产自动引擎按“联赛等级 + under/over 方向”使用最终校准概率门槛。
概率门槛不是未来胜率保证；最终校准概率、数据共识、盘口/赔率窗口、比赛时间/节奏、
剩余进球概率和风控仍必须同时通过。

- 足球明确重点：五大联赛、沙特职业/超级联赛、美职联、巴甲、葡超、荷甲、阿超、
  墨超、欧冠，以及其他合规超级/甲级联赛。under最终校准概率≥0.58，over≥0.68。
- 其他合规足球职业赛事：under≥0.62、over≥0.78。预备队、青年、女子、友谊赛、
  乙/丙/丁级和MLS NEXT不会因名称包含“联赛”而获得优先级。
- 篮球明确重点：NBA、ACB、欧洲篮球联赛，under≥0.58、over≥0.68；其他合规
  篮球职业赛事under≥0.62、over≥0.78。
